    ...
    <div className="flex min-h-screen flex-col items-center justify-center p-6 bg-gradient-to-tr from-primary-50 via-white to-accent-50">
      ...
      <div className="glassmorphism p-8 sm:p-12 w-full max-w-md space-y-8">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-gradient">Join the Vibe</h1>
          <p className="mt-2 text-gray-600">Create an account to find your tribe</p>
        </div>
        ...
        <div className="text-center text-sm text-gray-600">
          <p>Already have an account? <Link href="/sign-in" className="text-primary-600 hover:text-primary-800 font-medium">Sign in</Link></p>
        </div>
      </div>
    </div>
  );
